...
fn keygen_sane() {
    ...
    // helpers::keygen_sane::<HybridKemDem<UpEncCipher, RegCipher>>();
...
fn write_keyfile_sane() {
   ...
   // helpers::write_keyfile_sane::<HybridKemDem<UpEncCipher, RegCipher>>();
...
fn keyfile_rt() {
    ...
    // helpers::keyfile_rt::<HybridKemDem<UpEncCipher, RegCipher>>();
...
fn filecrypt_rt() {
    ...
    // helpers::filecrypt_rt::<HybridKemDem<UpEncCipher, RegCipher>>(32);
...
fn encrypt_update_once() {
    ...
    // helpers::encrypt_update_once::<HybridKemDem<UpEncCipher, RegCipher>>(32);
...
fn encrypt_update_many() {
    ...
    // helpers::encrypt_update_many::<HybridKemDem<UpEncCipher, RegCipher>>(32);
